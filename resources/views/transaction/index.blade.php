                            ...
                            <tr class="text-nowrap bg-white">
                                ...
                                <td class="flex text-center px-6 py-4">
                                    <div x-data="{ isOpen: false }">
                                        ...
                                        <div x-show="isOpen" @click.away="isOpen = false" :class="[isOpen && '!block']"
                                            x-trap.noscroll="isOpen" class="hidden fixed z-10 inset-0 overflow-y-auto">
                                            <div
                                                    ...
                                                    <div class="bg-gray-100 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                                        ...
                                                        <div class="sm:flex sm:items-start">
                                                            <div class="text-center sm:mt-0 sm:text-left w-full">
                                                                ...
                                                                {{-- <div class="w-full sm:mx-0 sm:w-full mb-4">
                                                                    <div
                                                                        class="bg-white overflow-hidden shadow-lg rounded-lg">
                                                                        <div
                                                                            class="sm:grid md:flex py-4 px-10 items-center">
                                                                            <div class="">
                                                                                <div
                                                                                    class="rounded-full bg-black w-12 h-12 items-center">
                                                                                </div>
                                                                            </div>
                                                                            <div class="text-left sm:grid md:flex ms-4">
                                                                ...
                                                                <div class="w-full sm:mx-auto sm:w-full mb-4">
                                                                    <div
                                                                        class="bg-white overflow-hidden shadow-lg rounded-lg">
                                                                        <div
                                                                            class="sm:grid md:flex py-4 px-10 items-center">
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    class="rounded-full bg-black w-12 h-12 flex items-center justify-center">
                                                                                    <!-- Isi konten di sini -->
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                class="text-left sm:grid md:flex sm:justify-center mt-3  ms-4">
                                                                                <div
                                                                                    class="flex justify-center items-center mr-6 mb-4 sm:mb-0">
                                                                                    <svg width="20" height="20"
                                                                                        viewBox="0 0 20 20"
                                                                                        fill="none"
                                                                                        xmlns="http://www.w3.org/2000/svg">
